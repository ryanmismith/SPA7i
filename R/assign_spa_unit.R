...
assign_spa_unit <- function(township) {
  AE_twp <- c(
    ...
    "T14R5","T8R10","T8R7","T9R5","T9R7","T9R9","TDR2", "AE"
  )
  AW_twp <- c(
    "T5R15","T6R15","T7R13","T7R14","T7R15",
    "T8R11","T8R12","T8R13","T8R14","T9R11","T9R13", "AW"
  )
  RY_twp <- c(
    "CSurp","CTown","Davis","LCup","Lincoln",
    "Magal","Oxbow","Rich","UCup","Upton", "RY"
  )
  SP_twp <- c(
    "T10R15","T10R16","T11R15","T11R16","T12R15",
    "T13R15","T15R13","T15R15","T16R12","T16R13","T16R14", "SP"
  )
